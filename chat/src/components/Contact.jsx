import { Upload, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
            ...
            <div className="relative">
              ...
              <div className="mt-auto">
                ...
                <div className="mt-3 flex space-x-4">
                  <Facebook className="h-5 w-5 text-gray-400 transition-colors hover:text-white" />
                  <Twitter className="h-5 w-5 text-gray-400 transition-colors hover:text-white" />
                  <Instagram className="h-5 w-5 text-gray-400 transition-colors hover:text-white" />
