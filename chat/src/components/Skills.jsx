...
export default function Skills() {
  ...
  return (
    <section ref={sectionRef} className="container mx-auto px-10 pb-10 py-10 md:py-60 md:px-28 md:mt-[-10%] bg-black min-w-screen h-[100%]">
      <div className="grid gap-8 lg:grid-cols-2 ">
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            {/* Standard button */}
            <button className="bg-red-900 text-white py-2 px-4 rounded">LEARN MORE</button>
            <button className="border border-red-500 text-red-900 py-2 px-4 rounded flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="space-y-2">
            <div className="text-4xl font-bold text-red-600">{completedProjectsCount}+</div>
            <div className="text-sm text-muted-foreground text-white">Completed Projects</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl font-bold text-red-600">{ongoingProjectsCount}+</div>
            <div className="text-sm text-muted-foreground text-white">On Going Projects</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl font-bold text-red-600">{happyClientsCount}+</div>
            <div className="text-sm text-muted-foreground text-white">Happy Clients</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl font-bold text-red-600">{officesCount}</div>
